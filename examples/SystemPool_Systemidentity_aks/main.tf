# =============================================================================
# BASIC DEV ENVIRONMENT EXAMPLE
# =============================================================================
# This example creates a minimal AKS cluster for development with:
# - System assigned identity
# - System node pool only (no user pools)
# - Storage account logging
# - NAT Gateway disabled
# - Private endpoints disabled (dev environment)
# - All GSO mandatory features (disk encryption, private cluster, etc.)

module "systempool_systemidentity_aks" {
  source = "../../"
