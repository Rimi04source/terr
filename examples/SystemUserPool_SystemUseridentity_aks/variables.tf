...
variable "aks_cluster_name" {
  ...
  type        = string
  default     = "aks-prod-example"
}

variable "resource_group_name" {
  description = "Name of the resource group"
  type        = string
  default     = "rg-aks-prod-example"
}
...
variable "service_exposure_type" {
  description = "How to expose services"
  type        = string
...
variable "log_storage_type" {
  description = "Log storage strategy"
  type        = string
  default     = "both"
}
...
variable "internal_lb_frontend_name" {
  description = "Internal LB frontend name"
  type        = string
  default     = "internal-lb-frontend"
}

variable "internal_lb_ip_allocation" {
  description = "Internal LB IP allocation"
  type        = string
  default     = "Dynamic"
}
...
variable "windows_outbound_nat_enabled" {
  description = "Enable Windows outbound NAT"
  type        = bool
  default     = true
}
